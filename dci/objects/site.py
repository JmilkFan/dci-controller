...
class Site(base.DCIObject, object_base.VersionedObjectDictCompat):
    ...
    fields = {
        ...
        'os_auth_url': object_fields.StringField(nullable=False),
        'os_region': object_fields.StringField(nullable=False),
        'os_project_domain_name': object_fields.StringField(nullable=False),
        'os_user_domain_name': object_fields.StringField(nullable=False),
        'os_project_name': object_fields.StringField(nullable=False),
        'os_username': object_fields.StringField(nullable=False),
        'os_password': object_fields.StringField(nullable=False),
